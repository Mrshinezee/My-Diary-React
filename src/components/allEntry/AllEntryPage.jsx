...
class AllEntryPage extends Component {
    ...
    render() {
        const { entries, entry, pullEntries, deleteEntry, updateEntry, singleEntry, auth: { token } } = this.props;
        return (
            <Fragment>
                ...
                <div id="main">
                    ...
                    updateEntry={updateEntry} singleEntry={singleEntry} entry={entry} token={token}/>
                </div>
                <footer>
